							...
							<div class="portlet solid bordered light-grey">
								...
								<div class="portlet-body">
									...
									<div id="site_statistics_loading">
										...
										<img src="${request.contextPath}/media/image/loading.gif" alt="loading" />
												...
												<div class="scroller" data-height="290px" data-always-visible="1" data-rail-visible1="1">
													...
													<div class="row-fluid">
														...
														<div class="span6 user-info">
															...
															<img alt="" src="${request.contextPath}/media/image/avatar.png" />
									...
									<div class="scroller" data-height="435px" data-always-visible="1" data-rail-visible1="1">
										...
										<ul class="chats">
											...
											<li class="in">
												...
												<img class="avatar" alt="" src="${request.contextPath}/media/image/avatar1.jpg" />
											...
											<li class="out">
												...
												<img class="avatar" alt="" src="${request.contextPath}/media/image/avatar2.jpg" />
											...
											<li class="out">
												...
												<img class="avatar" alt="" src="${request.contextPath}/media/image/avatar3.jpg" />
